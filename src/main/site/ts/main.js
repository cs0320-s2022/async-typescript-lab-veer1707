...
const firstInput = document.querySelector('#sun');
const secondInput = document.querySelector('#moon');
const thirdInput = document.querySelector('#rising');
const fourthInput = document.querySelector('#suggestions');
